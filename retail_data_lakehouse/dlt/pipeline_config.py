...
SILVER_SALES_TRANSACTIONS = f"{SILVER_SCHEMA}.silver_sales_transaction"
SILVER_RETURNS_TRANSACTIONS = f"{SILVER_SCHEMA}.silver_returns_transaction"
...
GOLD_DENORMALIZED_SALES_FACTS = f"{GOLD_SCHEMA}.gold_denormalized_sales_facts"
